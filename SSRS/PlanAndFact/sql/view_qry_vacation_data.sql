...
/****** Object:  View [dbo].[QRY_VACATION_DATA]    Script Date: 06.02.2025 15:52:43 ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [dbo].[QRY_VACATION_DATA]
AS
...
from Vitro.dbo.vacation v
left join WSS_Content.dbo.AllUserData f with (nolock) on CAST(f.float1 as int) = v.Num and f.tp_ListId = 'B4C516DB-A26D-48FA-A322-4780A5D4BE91' and f.tp_DeleteTransactionId = 0x and f.tp_IsCurrent = 1
